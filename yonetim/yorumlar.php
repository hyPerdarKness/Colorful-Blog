...
echo "<div class='warning msg' style='width:200px;'><b>Yorum silindi.</b></div><br>"; echo '<meta http-equiv="refresh" content="2;URL=yorumlar.php">'; } ?>				
			<h3 class="tit">Onaylanmamış Yorumlar</h3>
			<table>
				<tr>
				    <th>Ad Soyad</th>
				    <th>E-Mail</th>
...
<?php foreach($db->query("select * from comments where onoff='0' order by id desc") as $aaa){ $id = $aaa['id']; ?>					
			<?php if($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    <td style="width:300px;"><?php echo $aaa['adsoyad']; ?></td>
				    <td style="width:400px;"><?php echo $aaa['email']; ?></td>
				    <td style="width:120px;"><?php echo timeConvert($aaa['tarih']); ?></td>
				    <td style="width:110px;"><?php echo $aaa['ip']; ?></td>					
				    <td style="width:100px;" align="center"><a href="yorumedit.php?id=<?php echo $aaa['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; 
					<a href="yorumlar.php?sil=<?php echo $aaa['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
			<?php } ?>
			</table>
			<br><br>
			
			<h3 class="tit">Onaylanmış Yorumlar</h3>
			<table>
				<tr>
				    <th>Ad Soyad</th>
				    <th>E-Mail</th>
...
<?php foreach($db->query("select * from comments where onoff='1' order by id desc") as $bbb){ $id1 = $bbb['id']; ?>					
			<?php if($id1%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    <td style="width:300px;"><?php echo $bbb['adsoyad']; ?></td>
				    <td style="width:400px;"><?php echo $bbb['email']; ?></td>
				    <td style="width:120px;"><?php echo timeConvert($bbb['tarih']); ?></td>
				    <td style="width:110px;"><?php echo $bbb['ip']; ?></td>					
				    <td style="width:100px;" align="center"><a href="yorumedit.php?id=<?php echo $bbb['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; 
					<a href="yorumlar.php?sil=<?php echo $bbb['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
			<?php } ?>
			</table>			

...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			<h1>Yönetici Bilgileri</h1><br>
<?php if(isset($_POST['gonder'])){ $username = $_POST['username']; $password = $_POST['password']; $parola = md5($password);

if($username==""||$password==""){ echo '<div class="error msg" style="width:300px;"><b>Bir hata oluştu. Lütfen yeniden deneyiniz.</b></div><br>'; }else{

$db->query("UPDATE yonetim SET username='$username',password='$parola' where id='".$id."'");
...
echo "<div class='done msg' style='width:200px;'><b>Düzenleme Kaydedildi!</b></div><br>"; echo '<meta http-equiv="refresh" content="2">'; } } ?>			
						...
						<input type="text" size="40" name="username" value="<?php echo $_SESSION['tech']; ?>" class="input-text" /><br><br>
					
						<label><b>Şifre</b></label><br>
						<input type="text" size="50" name="password" class="input-text" placeholder="bu alanı sadece şifre değiştirmek istediğinizde doldurun!" /><br><br>

...
if($baslik==""||$sira==""){ echo '<div class="error msg" style="width:300px;"><b>Bütün alanları doldurmanız gerekmektedir.</b></div><br>'; }else{

$kayit = $db->prepare("insert into blogkategori SET sira=?,baslik=?,sefurl=?"); $kayit->execute(array($sira, $baslik, $url));

echo "<div class='done msg' style='width:200px;'><b>Kategori Eklendi!</b></div>"; echo '<meta http-equiv="refresh" content="2">'; } } ?>
						<form method="post">
							<div class="col50">
				...
				<p class="t-justify">   
						...
						<input type="text" size="40" name="sira" class="input-text" /><br><br>
					
						<label><b>Başlık</b></label><br>
						<input type="text" size="40" name="baslik" class="input-text" /><br><br><br>

...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h1>Yazılar</h1><br><br>
<?php if(isset($_GET['sil'])){ $sil = intval($_GET['sil']); $db->query("delete from blog where id='".$sil."'"); 
echo "<div class='warning msg' style='width:200px;'><b>Yazı silindi.</b></div><br>"; echo '<meta http-equiv="refresh" content="2;URL=yazilar.php">'; } ?>				
			<table>
				<tr>
				    <th>Başlık</th>
...
<?php $limit = 25; $page = @$_GET["page"]; if(empty($page) or !is_numeric($page)){ $page = 1; }
...
foreach($ver as $yazdir){ $id = $yazdir['id']; ?>				
			<?php if($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    <td style="width:1000px;"><?php echo $yazdir['baslik']; ?></td>			
				    <td align="center" style="width:150px;"><?php $ggg = $db->query("select * from blogkategori where sefurl='".$yazdir['kategori']."'")->fetch(PDO::FETCH_ASSOC); echo $ggg['baslik'];  ?></td>
				    <td align="center" style="width:120px;"><?php echo timeConvert($yazdir['tarih']); ?></td>					
				    <td style="width:100px;" align="center"><a href="yaziedit.php?id=<?php echo $yazdir['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; 
					<a href="yazilar.php?sil=<?php echo $yazdir['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
<?php } echo '</table><br>';
 if($count > $limit) : 
  $x = 2; 

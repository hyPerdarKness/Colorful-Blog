...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h1>Yazı Kategorileri</h1><br><br>
<?php if(isset($_GET['sil'])){ $sil = intval($_GET['sil']); $db->query("delete from blogkategori where id='".$sil."'"); 
echo "<div class='warning msg' style='width:200px;'><b>Kategori silindi.</b></div><br>"; echo '<meta http-equiv="refresh" content="2;URL=yazikategori.php">'; } ?>				
			<table>
				<tr>
...
<?php foreach($db->query("select * from blogkategori order by id desc") as $aaa){ $id = $aaa['id']; ?>					
			<?php if($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    <td align="center" style="width:100px;"><?php echo $aaa['sira']; ?></td>
				    <td style="width:1000px;"><?php echo $aaa['baslik']; ?></td>
				    <td style="width:100px;" align="center"><a href="yazikatedit.php?id=<?php echo $aaa['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; 
					<a href="yazikategori.php?sil=<?php echo $aaa['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
			<?php } ?>
			</table>
			<br>
			<p class="info msg"><b>Sıra No site sağ sütundaki sıralamayı(1,2,3...) sağlamaktadır. Lütfen ekleme veya düzenleme yaparken bunu göz önünde bulundurun.</b></p>
